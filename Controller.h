...
public:
    ...
    void tick()
    {
        ...
        // only executes if this is the first time a command is being issued for the selected request
        if (req->is_first_command) {
            // 18-740: This is what executes when a new request has been selected for scheduling
            // For BLISS, this is where you want to determine how many requests a core has issued
            // You may need to reset it somewhere else
